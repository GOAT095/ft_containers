...
#include "../map/map-utils.hpp"  // path to ft::pair.
...
bool testMapConstructors()
{
    ...
    // std::cout << "begin = " << m_first.begin()->first << "value  = " << m_first.begin()->second <<  std::endl;
    ...
    ft::Map<char, int>::iterator beg = m_first.begin();
    ft::Map<char, int>::iterator end = m_first.end();
    // for (; beg != end; beg++)
